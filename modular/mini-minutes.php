<!--
    Module name:
        Mini Minutes
    Description:
        This is the modular file for mini meeting minutes.
        All changes of this modular will update automatically on the main page.
-->
...
<!-- Row 01 -->
    ...
    <div class="flip-card w3-col l3 m6 w3-margin-bottom">
        <div class="flip-card-inner">
            <div class="flip-card-front mm-casual-l2 w3-display-container">
